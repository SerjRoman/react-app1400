...
export function SearchBar(){
    ...
    function searchProducts(event: ChangeEvent<HTMLInputElement>) {
    ...
    return(
        <div ref={modalContainerRef}>
             <input className="input" type="text" placeholder="Пошук продуктів..." onFocus={inputOnFocus} onClick={(event) => {event.stopPropagation()}} onChange={searchProducts}/>
             { isModalOpen === true 
                    ? 
